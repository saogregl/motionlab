...
import { TimelineScrubber } from '@/components/primitives/timeline-scrubber';
import { TimelineTransport } from '@/components/primitives/timeline-transport';
...
const TREE_NODES: TreeNode[] = [
  // Bodies (8)
  { id: 'g-bodies', parentId: null, level: 0, name: 'Bodies', hasChildren: true, isGroup: true, count: 8 },
  { id: 'b-housing', parentId: 'g-bodies', level: 1, name: 'Housing', hasChildren: false, entityType: 'body' },
  { id: 'b-crankshaft', parentId: 'g-bodies', level: 1, name: 'Crankshaft', hasChildren: false, entityType: 'body' },
  { id: 'b-con-rod', parentId: 'g-bodies', level: 1, name: 'Connecting Rod', hasChildren: false, entityType: 'body' },
  { id: 'b-piston', parentId: 'g-bodies', level: 1, name: 'Piston', hasChildren: false, entityType: 'body' },
  { id: 'b-flywheel', parentId: 'g-bodies', level: 1, name: 'Flywheel', hasChildren: false, entityType: 'body' },
  { id: 'b-cam-shaft', parentId: 'g-bodies', level: 1, name: 'Camshaft', hasChildren: false, entityType: 'body' },
  { id: 'b-rocker-arm', parentId: 'g-bodies', level: 1, name: 'Rocker Arm', hasChildren: false, entityType: 'body' },
  { id: 'b-valve', parentId: 'g-bodies', level: 1, name: 'Intake Valve', hasChildren: false, entityType: 'body' },

  // Datums (6)
  { id: 'g-datums', parentId: null, level: 0, name: 'Datums', hasChildren: true, isGroup: true, count: 6 },
  { id: 'd-crank-axis', parentId: 'g-datums', level: 1, name: 'Crank Axis', hasChildren: false, entityType: 'datum' },
  { id: 'd-piston-axis', parentId: 'g-datums', level: 1, name: 'Piston Axis', hasChildren: false, entityType: 'datum' },
  { id: 'd-cam-axis', parentId: 'g-datums', level: 1, name: 'Cam Axis', hasChildren: false, entityType: 'datum' },
  { id: 'd-tdc-plane', parentId: 'g-datums', level: 1, name: 'TDC Plane', hasChildren: false, entityType: 'datum' },
  { id: 'd-valve-seat', parentId: 'g-datums', level: 1, name: 'Valve Seat', hasChildren: false, entityType: 'datum' },
  { id: 'd-mount-face', parentId: 'g-datums', level: 1, name: 'Mount Face', hasChildren: false, entityType: 'datum' },

  // Joints (10)
  { id: 'g-joints', parentId: null, level: 0, name: 'Joints', hasChildren: true, isGroup: true, count: 10 },
  { id: 'j-crank-main', parentId: 'g-joints', level: 1, name: 'Crank Main Bearing', hasChildren: false, entityType: 'joint', jointType: 'revolute' },
  { id: 'j-crank-rod', parentId: 'g-joints', level: 1, name: 'Crank–Rod Pin', hasChildren: false, entityType: 'joint', jointType: 'revolute' },
  { id: 'j-rod-piston', parentId: 'g-joints', level: 1, name: 'Rod–Piston Pin', hasChildren: false, entityType: 'joint', jointType: 'revolute' },
  { id: 'j-piston-bore', parentId: 'g-joints', level: 1, name: 'Piston–Bore', hasChildren: false, entityType: 'joint', jointType: 'slider' },
  { id: 'j-flywheel', parentId: 'g-joints', level: 1, name: 'Flywheel Mount', hasChildren: false, entityType: 'joint', jointType: 'fixed' },
  { id: 'j-cam-bearing', parentId: 'g-joints', level: 1, name: 'Cam Bearing', hasChildren: false, entityType: 'joint', jointType: 'revolute' },
  { id: 'j-cam-rocker', parentId: 'g-joints', level: 1, name: 'Cam–Rocker', hasChildren: false, entityType: 'joint', jointType: 'cylindrical' },
  { id: 'j-rocker-pivot', parentId: 'g-joints', level: 1, name: 'Rocker Pivot', hasChildren: false, entityType: 'joint', jointType: 'revolute' },
  { id: 'j-valve-guide', parentId: 'g-joints', level: 1, name: 'Valve Guide', hasChildren: false, entityType: 'joint', jointType: 'slider' },
  { id: 'j-housing-fixed', parentId: 'g-joints', level: 1, name: 'Housing Fixed', hasChildren: false, entityType: 'joint', jointType: 'fixed' },

  // Drivers (4)
  { id: 'g-drivers', parentId: null, level: 0, name: 'Drivers', hasChildren: true, isGroup: true, count: 4 },
  { id: 'dr-crank-torque', parentId: 'g-drivers', level: 1, name: 'Crank Torque', hasChildren: false, entityType: 'driver' },
  { id: 'dr-valve-spring', parentId: 'g-drivers', level: 1, name: 'Valve Spring', hasChildren: false, entityType: 'driver' },
  { id: 'dr-friction', parentId: 'g-drivers', level: 1, name: 'Bore Friction', hasChildren: false, entityType: 'driver' },
  { id: 'dr-gas-pressure', parentId: 'g-drivers', level: 1, name: 'Gas Pressure', hasChildren: false, entityType: 'driver' },

  // Sensors (2)
  { id: 'g-sensors', parentId: null, level: 0, name: 'Sensors', hasChildren: true, isGroup: true, count: 2 },
  { id: 's-crank-speed', parentId: 'g-sensors', level: 1, name: 'Crank Speed', hasChildren: false, entityType: 'sensor' },
  { id: 's-piston-accel', parentId: 'g-sensors', level: 1, name: 'Piston Accel', hasChildren: false, entityType: 'sensor' },
];
...
function MotionLabShellDemo() {
  ...
  const selectedNode = useMemo(
    () => TREE_NODES.find((n) => selectedIds.has(n.id)),
    [selectedIds],
  );

  // Keyboard shortcuts
  useHotkey('Mod+K', (e) => { e.preventDefault(); setCommandOpen((o) => !o); });
              ...
              renderRow={(node, props) => {
                ...
                return (
                  <TreeRow
                    level={node.level}
                    name={node.name}
                    icon={<EntityIcon type={node.entityType as string} jointType={node.jointType as string | undefined} />}
            ...
            <ViewportHUD
              ...
              bottomCenter={
                selectedNode && !selectedNode.isGroup ? (
                  <SelectionChip
                    icon={<EntityIcon type={selectedNode.entityType as string} jointType={selectedNode.jointType as string | undefined} />}
          ...
          <RightPanel>
            {selectedNode && !selectedNode.isGroup ? (
              <InspectorPanel
                ...
                entityType={(selectedNode.entityType as string)?.replace(/^\w/, (c: string) => c.toUpperCase())}
                entityIcon={<EntityIcon type={selectedNode.entityType as string} jointType={selectedNode.jointType as string | undefined} />}
                statusLine="Compiled"
                quickActions={
                ...
                {selectedNode.entityType === 'joint' && (
                  <InspectorSection title="Joint">
                    ...
                    <PropertyRow label="Body A">
                      <span className="flex h-6 items-center text-[length:var(--text-sm)] text-text-primary">Housing</span>
                    </PropertyRow>
      ...
      <CommandDialog open={commandOpen} onOpenChange={setCommandOpen}>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Actions">
            {COMMANDS.map((cmd) => (
              <CommandItem key={cmd.id} onSelect={() => { console.log('[command]', cmd.label); setCommandOpen(false); }}>
                {cmd.label}
              </CommandItem>
            ))}
          </CommandGroup>
